                                        ...
                                        <div class='modal fade' id='exampleModal$idx' tabindex='-1' aria-labelledby='exampleModalLabel$idx' aria-hidden='true'>
                                            ...
                                            <div class='modal-content'>
                                                ...
                                                <form action='editar.php' method='post'>
                                                    ...
                                                    <input value='" . htmlspecialchars($usuario['qt']) . "' class='form-control' type='number' name='qtPro' required/>
                                                    <br/>
                                                    <label class='form-label'>prejuizo</label>
                                                    <input value='" . htmlspecialchars($usuario['preju']) . "' class='form-control' type='number' name='preju' required/>
                                                    <br/>
